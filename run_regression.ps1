...
$rtlSources = @(
    ...
    'rtl/multi_read_scratchpad.sv',
    'rtl/operand_feeder.sv',
    'rtl/parallel_operand_feeder.sv',
    'rtl/requant_relu.sv',
    ...
    'fpga/de25_standard/rtl/de25_standard_selftest_top.sv'
)
...
$testbenchSources += Get-ChildItem -LiteralPath 'tb\integration' -Filter '*.sv' |
    Sort-Object Name |
    ForEach-Object { $_.FullName }
$testbenchSources += Get-ChildItem -LiteralPath 'tb\fpga' -Filter '*.sv' |
    Sort-Object Name |
    ForEach-Object { $_.FullName }
...
$unitTests = @(
    ...
    'tb_mac_array_4x4',
    'tb_scratchpad_sram',
    'tb_multi_read_scratchpad',
    'tb_operand_feeder',
    'tb_parallel_operand_feeder',
    'tb_requant_relu',
