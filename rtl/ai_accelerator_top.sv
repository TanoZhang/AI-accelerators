// Top-level integration for the single-clock INT8 accelerator.
module ai_accelerator_top #(
  ...
  logic [31:0] activation_read_data;
  logic activation_read_valid;
  logic signed [DATA_W-1:0] activation_operand;
  ...
  logic signed [DATA_W-1:0] weight_operand;
  ...
  assign activation_operand = $signed(activation_read_data[DATA_W-1:0]);
  assign weight_operand = $signed(weight_read_data[DATA_W-1:0]);
